    ...
    <section className="relative bg-primaryColor text-white py-16 px-6 z-0 font-droidSans">
      ...
      <div className="max-w-7xl mx-auto flex gap-24 flex-col md:flex-row items-start relative z-10">
        ...
        <div ref={leftRef} className="md:w-1/2">
          ...
          <button onClick={() => navigate('/contact')} className="bg-blue-500 text-white px-6 py-2 rounded-md hover:bg-blue-600 transition duration-300">
            Get in Touch
          </button>
        </div>

        {/* Right side image */}
        <div ref={rightRef} className="md:w-1/2 mt-8 md:mt-0 border border-white my-auto">
          <img
            src={witchImg}
